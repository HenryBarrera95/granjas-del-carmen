...
const ContentSection = () => {
  ...
  const onsubmitForm = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (email && name) {
      // CREAR USUARIO EN LA LISTA DE LA DB
    }
  ...
  return (
    <main className="">
        ...
        <div className="container space-y-12 px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                únicas. Ven a explorar nuestros conejos y encuentra tu compañero
                perfecto.
              </p>
            </div>
          </div>
          <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
            ...
            <div className="grid gap-1">
              ...
              <p className="text-sm text-[#5c5c5c]">
                Una raza compacta y enérgica con un patrón de color distintivo.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center flex-col sm:flex-row items-start gap-4">
            ...
            <Link
              className="inline-flex h-10 items-center justify-center rounded-md border border-[#8c6239] bg-emptybg px-8 text-sm font-medium shadow-sm transition-colors hover:bg-emptybg/90 hover:text-[#8c6239] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#8c6239] disabled:pointer-events-none disabled:opacity-50"
              href="#"
            >
              Aprender Más
            </Link>
      ...
      <section className="w-full py-8 md:py-16 lg:py-32 bg-[#e0d1c1]">
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          <div className="space-y-3">
            ...
            <p className="mx-auto max-w-[600px] text-[#5c5c5c] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Nuestra granja ofrece una oportunidad única para conectarte con la
              naturaleza y disfrutar de la compañía de nuestros adorables
              conejos. Únete a nosotros y descubre la alegría de ser dueño de
              conejos.
            </p>
          </div>
          <div className="space-y-2 justify-self-center">
            ...
            <form
              className="block md:flex justify-center space-y-2 md:space-y-0"
            ...
            >
              <label htmlFor="name">
                ...
                <input
                  ...
                  required
                  className="bg-emptybg text-[#5c5c5c] mx-2"
                />
              </label>
              <label htmlFor="email">
                Correo
              ...
              <button
                type="submit"
                className="bg-[#8c6239] text-primaryBg hover:bg-[#8c6239]/90 
                p-1 md:p-2 m-1"
              >
                Enviar
              </button>
                ...
                <li>
                  <div className="grid gap-1 pt-4">
                    ...
                    <p className="text-[#5c5c5c]">
                      ...
                      aseguramos de que sean tratados con el máximo cuidado y
                      respeto.
                    </p>
                  </div>
                </li>
