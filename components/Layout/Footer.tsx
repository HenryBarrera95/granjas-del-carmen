...
const Footer: React.FC = () => {
  return (
    ...
    >
      {/* <div className="bg-primaryBg w-1/3 rounded-xl mx-auto p-2"> */}
        <div className="flex justify-center space-x-5">
          <a href="https://www.facebook.com/GranjasdelCarmen/" role="button">
            {/* <!-- Facebook --> */}
          ...
          <a href="https://www.instagram.com/granjasdelcarmen/" role="button">
            {/* <!-- Instagram --> */}
          ...
          <a href="https://wa.me/+57" role="button">
            {/* <!-- Whatsapp --> */}
