...
const about = () => {
  return (
    ...
    <section className="mb-32">
      <div className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-[url('https://www.idausa.org/assets/files/farmed-animals/ssi-group-of-rabbits-2056157612-0922-source-shutterstock.jpg')]"></div>
