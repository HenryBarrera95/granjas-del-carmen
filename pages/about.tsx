  ...
  return (
    <div className="container my-24 mx-auto md:px-6">
      ...
      <section className="mb-32">
        <div className="relative h-[300px] bg-cover bg-[50%] bg-no-repeat bg-[url('https://www.idausa.org/assets/files/farmed-animals/ssi-group-of-rabbits-2056157612-0922-source-shutterstock.jpg')]"></div>
        <div className="container px-6 md:px-12">
          <div className="rounded-lg bg-blackLigth px-6 py-12 shadow-xl dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 -mt-[100px] backdrop-blur-[30px]">
